...
class SphereTest {
	...
	void testFindIntersections() {
		...
		assertEquals(new Point(1, 1, Math.sqrt(23) + 1), sphere.findIntersections(ray1).get(0),
				"This point is not the correct point");
		assertEquals(1, sphere.findIntersections(ray1).size(), "The amount of intersections should be 1");

		// TC02: Testing two points of intersection, ray starts outside the sphere
		Ray ray2 = new Ray(new Point(1, 1, -5), new Vector(0, 0, 1));
		assertTrue(
				sphere.findIntersections(ray2).contains(new Point(1, 1, Math.sqrt(23) + 1))
						&& sphere.findIntersections(ray2).contains(new Point(1, 1, -Math.sqrt(23) + 1)),
		...
		assertEquals(null, sphere.findIntersections(ray3), "There should be no intersections");
		...
		assertEquals(null, sphere.findIntersections(ray4), "There should be no intersections");

		// =============== Boundary Values Tests ==================
		// group 1 - the ray cuts the center
		// TC01: Testing one point of intersection, ray starts in the center of the
		// sphere
		Ray ray5 = new Ray(new Point(0, 0, 1), new Vector(0, 0, 1));
		assertEquals(new Point(0, 0, 6), sphere.findIntersections(ray5).get(0), "This point is not the correct point");
		assertEquals(1, sphere.findIntersections(ray5).size(), "The amount of intersections should be 1");
		...
		assertEquals(null, sphere.findIntersections(ray6), "There should be no intersections");

		// TC03: Testing 1 point of intersection, ray starts in the edge and passing by
		// the sphere
		Ray ray7 = new Ray(new Point(0, 0, -4), new Vector(0, 0, 1));
		assertEquals(new Point(0, 0, 6), sphere.findIntersections(ray7).get(0), "This point is not the correct point");
		assertEquals(1, sphere.findIntersections(ray7).size(), "The amount of intersections should be 1");

		// TC04: Testing 0 points of intersection, ray starts outside of the sphere
		Ray ray8 = new Ray(new Point(0, 0, 7), new Vector(0, 0, 1));
		assertEquals(null, sphere.findIntersections(ray8), "There should be no intersections");

		// TC05: Testing 0 points of intersection, ray starts outside of the sphere
		Ray ray9 = new Ray(new Point(0, 0, -5), new Vector(0, 0, 1));
		assertTrue(sphere.findIntersections(ray9).contains(new Point(0, 0, -4)), "The correct point is missing");
		assertTrue(sphere.findIntersections(ray9).contains(new Point(0, 0, 6)), "The correct point is missing");
		...
		assertEquals(new Point(1, 1, Math.sqrt(23) + 1), sphere.findIntersections(ray11).get(0),
				"This point is not the correct point");
		assertEquals(1, sphere.findIntersections(ray11).size(), "The amount of intersections should be 1");
		...
		assertEquals(null, sphere.findIntersections(ray12), "There should be no intersections");
