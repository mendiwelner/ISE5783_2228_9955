...
class SphereTest {
	...
	/**
	 * Test method for
	 * {@link geometries.Sphere#testFindIntsersections(primitives.Point)}.
	 */
	@Test
	void testFindIntersections() {
		...
		assertEquals(new Point(0, 0, 6), sphere.findIntsersections(ray5).get(0), "This point is not the correct point");
		assertEquals(1, sphere.findIntsersections(ray5).size(), "The amount of intersections should be 1");
		...
		assertEquals(new Point(0, 0, 6), sphere.findIntsersections(ray7).get(0), "This point is not the correct point");
		assertEquals(1, sphere.findIntsersections(ray7).size(), "The amount of intersections should be 1");
		...
		assertTrue(sphere.findIntsersections(ray9).contains(new Point(0, 0, -4)), "The correct point is missing");
		assertTrue(sphere.findIntsersections(ray9).contains(new Point(0, 0, 6)), "The correct point is missing");
		...
		assertEquals(new Point(0, 0, 6), sphere.findIntsersections(ray10).get(0),
				"This point is not the correct point");
