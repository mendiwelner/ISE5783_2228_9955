...
class TriangleTest {
	...
	void testConstructor() {
		...
		assertThrows(IllegalArgumentException.class,() -> new Triangle(new Point(1,2,3),new Point(1,2,3),new Point(5,5,5))
				,"All points must be diffrent");
		
		//TC03: Points on the same line
		assertThrows(IllegalArgumentException.class,() -> new Triangle(new Point(1,2,3),new Point(2,3,4),new Point(4,5,6))
