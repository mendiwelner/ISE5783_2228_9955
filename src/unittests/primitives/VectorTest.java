...
public class VectorTest {
	...
	void testSubtractVector() {
		...
		// =============== Boundary Values Tests ==================
		// TC03: Getting the zero vector
		assertThrows(IllegalArgumentException.class, () -> v.subtract(v), "This should be exeption of vector(0,0,0)");
	}
	...
	void testScale() {
		...
		assertEquals(0, v.scale(2.5d).length() - new Vector(2.5d, 5d, 7.5d).length(), 0.00000001);

		// =============== Boundary Values Tests ==================
		// TC04: Getting the zero vector
		assertThrows(IllegalArgumentException.class, () -> v.scale(0), "0*(1,2,3) should be exeption of vector(0,0,0)");
	}
